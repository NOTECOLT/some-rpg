...
public class DialogueManager : MonoBehaviour {
    ...
    private void EquipWeapon(string weaponid, int playerid) {
        ...
        if (PlayerDataManager.Instance.Data.PartyStats[playerid].Weapon != null) {
            WeaponItem oldWeapon = PlayerDataManager.Instance.Data.PartyStats[playerid].Weapon;
            PlayerDataManager.Instance.Data.Inventory.Add(oldWeapon);
        }
        
        PlayerDataManager.Instance.Data.PartyStats[playerid].Weapon = new WeaponItem((WeaponData)GameStateMachine.Instance.Items[weaponid]);
